#ifndef MMX_MLIB_H_INCLUDED
#define MMX_MLIB_H_INCLUDED
...
/* Use the fuctions for mpeg2dec's idtc_mmx.c file */
extern void idct_block_copy_mmx(int16_t * block, uint8_t * dest, int stride);
extern void idct_block_add_mmx(int16_t * block, uint8_t * dest, int stride);

#define mlib_VideoIDCTAdd_U8_S16(block,coeffs,stride) \
 idct_block_add_mmx(coeffs, block, stride)

#define mlib_VideoIDCT8x8_U8_S16(block,coeffs,stride) \
 idct_block_copy_mmx(coeffs, block, stride)

#endif /* MMX_MLIB_H_INCLUDED */
