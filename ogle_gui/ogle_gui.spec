...
Requires: ogle >= 0.9.2, gtk+ >= 1.2.0, libxml2, libglade, libglade.so.0
BuildRequires: ogle-devel >= 0.9.2, gtk+-devel >= 1.2.0, libxml2-devel >= 2.4.19, libglade-devel
...
%changelog
* Wed Nov 05 2003 Björn Englund <d4bjorn@dtek.chalmers.se>
